...
describe('', () => {
    ...
    describe('DATABASE TESTS', () => {
        it('should get all the places from the database', (done) => {
            agent
                .get('/api/v1/places')
                .then((res) => {
        ...
        it('should get a place by name and print out the details about the place', (done) => {
            agent
        ...
        it('should return msg : Place does not exist, add it; when place is not in the databse', (done) => {
            agent
        ...
        it('should update place from the database and return the updated place', (done) => {
            agent
        ...
        it('should remove place from the database and return length of items decremented by one', (done) => {
            agent
    ...
    after((done) => {
        let PlaceRepo = typeorm_1.getRepository(Place_entity_1.Place);
