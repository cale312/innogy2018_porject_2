...
class Route {
    constructor() {
        this.visitedPlace = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const code = res.statusCode;
            let placeName = req.params._placeName;
            let placesRepository = yield typeorm_1.getRepository(Place_entity_1.Place);
            let placeVisited = yield placesRepository.findOne({ name: placeName });
...
//# sourceMappingURL=visitedPlaceRoute.js.map